...
<?php else : ?>
    ...
    <form action="/booking-app/admin-scripts/post-update-product.php?id=<?= $_GET["id"] ?>" method="post" enctype="multipart/form-data">
    ...
    <form action="/booking-app/admin-scripts/post-delete-product.php" method="post">
